...
public final class UpdateRemoteProcessGroupOutputPortInvoker extends ComponentEntityInvoker<RemoteProcessGroupPortEntity> {
  ...
  /**
   * The remote process group port. */
  public final UpdateRemoteProcessGroupOutputPortInvoker setRemoteProcessGroupPortEntity(final RemoteProcessGroupPortEntity remoteProcessGroupPortEntity) {
