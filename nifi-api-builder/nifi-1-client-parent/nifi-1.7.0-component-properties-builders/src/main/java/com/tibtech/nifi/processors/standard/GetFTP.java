...
public final class GetFTP {
   ...
   */
  public static final String COMPONENT_TYPE = "org.apache.nifi.processors.standard.GetFTP";
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final GetFTP setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final GetFTP removeProxyConfigurationService() {
   ...
   * Set the internal buffer size for buffered data streams
   */
  public final GetFTP setInternalBufferSize(final String internalBufferSize) {
   ...
   * Set the internal buffer size for buffered data streams
   */
  public final GetFTP removeInternalBufferSize() {
   ...
   * Tells the client to use UTF-8 encoding when processing files and filenames. If set to true, the server must also support UTF-8 encoding.
   */
  public final GetFTP setFtpUseUtf8(final String ftpUseUtf8) {
   ...
   * Tells the client to use UTF-8 encoding when processing files and filenames. If set to true, the server must also support UTF-8 encoding.
   */
  public final GetFTP removeFtpUseUtf8() {
