...
public final class PutSFTP {
   ...
   * If set to 'true', directory listing is not performed prior to create missing directories. By default, this processor executes a directory listing command to see target directory existence before creating missing directories. However, there are situations that you might need to disable the directory listing such as the following. Directory listing might fail with some permission setups (e.g. chmod 100) on a directory. Also, if any other SFTP client created the directory after this processor performed a listing and before a directory creation request by this processor is finished, then an error is returned because the directory already exists.
   */
  public final PutSFTP setDisableDirectoryListing(final String disableDirectoryListing) {
   ...
   * If set to 'true', directory listing is not performed prior to create missing directories. By default, this processor executes a directory listing command to see target directory existence before creating missing directories. However, there are situations that you might need to disable the directory listing such as the following. Directory listing might fail with some permission setups (e.g. chmod 100) on a directory. Also, if any other SFTP client created the directory after this processor performed a listing and before a directory creation request by this processor is finished, then an error is returned because the directory already exists.
   */
  public final PutSFTP removeDisableDirectoryListing() {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS + AuthN
   */
  public final PutSFTP setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS + AuthN
   */
  public final PutSFTP removeProxyConfigurationService() {
   ...
   * Proxy type used for file transfers
   */
  public final PutSFTP setProxyType(final String proxyType) {
   ...
   * Proxy type used for file transfers
   */
  public final PutSFTP removeProxyType() {
   ...
   * The fully qualified hostname or IP address of the proxy server
   */
  public final PutSFTP setProxyHost(final String proxyHost) {
   ...
   * The fully qualified hostname or IP address of the proxy server
   */
  public final PutSFTP removeProxyHost() {
   ...
   * The port of the proxy server
   */
  public final PutSFTP setProxyPort(final String proxyPort) {
   ...
   * The port of the proxy server
   */
  public final PutSFTP removeProxyPort() {
   ...
   * Http Proxy Username
   */
  public final PutSFTP setHttpProxyUsername(final String httpProxyUsername) {
   ...
   * Http Proxy Username
   */
  public final PutSFTP removeHttpProxyUsername() {
   ...
   * Http Proxy Password
   */
  public final PutSFTP setHttpProxyPassword(final String httpProxyPassword) {
   ...
   * Http Proxy Password
   */
  public final PutSFTP removeHttpProxyPassword() {
