...
public final class GetDynamoDB {
   ...
   * The items to be retrieved in one batch
   */
  public final GetDynamoDB setBatchItemsForEachRequestBetween1And50(
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final GetDynamoDB setAwsCredentialsProviderService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final GetDynamoDB setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final GetDynamoDB removeProxyConfigurationService() {
   ...
   * Proxy host name or IP
   */
  public final GetDynamoDB setProxyHost(final String proxyHost) {
   ...
   * Proxy host name or IP
   */
  public final GetDynamoDB removeProxyHost() {
   ...
   * Proxy host port
   */
  public final GetDynamoDB setProxyHostPort(final String proxyHostPort) {
   ...
   * Proxy host port
   */
  public final GetDynamoDB removeProxyHostPort() {
   ...
   * Proxy username
   */
  public final GetDynamoDB setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final GetDynamoDB removeProxyUserName() {
   ...
   * Proxy password
   */
  public final GetDynamoDB setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final GetDynamoDB removeProxyUserPassword() {
