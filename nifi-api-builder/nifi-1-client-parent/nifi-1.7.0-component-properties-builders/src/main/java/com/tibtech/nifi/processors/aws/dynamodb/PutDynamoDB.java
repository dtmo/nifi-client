...
public final class PutDynamoDB {
  ...
  public PutDynamoDB(final Map<String, String> properties) {
   ...
   * The items to be retrieved in one batch
   */
  public final PutDynamoDB setBatchItemsForEachRequestBetween1And50(
      final String batchItemsForEachRequestBetween1And50) {
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final PutDynamoDB setAwsCredentialsProviderService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutDynamoDB setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutDynamoDB removeProxyConfigurationService() {
   ...
   * Proxy host name or IP
   */
  public final PutDynamoDB setProxyHost(final String proxyHost) {
   ...
   * Proxy host name or IP
   */
  public final PutDynamoDB removeProxyHost() {
   ...
   * Proxy host port
   */
  public final PutDynamoDB setProxyHostPort(final String proxyHostPort) {
   ...
   * Proxy host port
   */
  public final PutDynamoDB removeProxyHostPort() {
   ...
   * Proxy username
   */
  public final PutDynamoDB setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final PutDynamoDB removeProxyUserName() {
   ...
   * Proxy password
   */
  public final PutDynamoDB setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final PutDynamoDB removeProxyUserPassword() {
  ...
  public static final Map<String, String> build(
      final Function<PutDynamoDB, PutDynamoDB> configurator) {
    return configurator.apply(new PutDynamoDB()).build();
  }

  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = PutDynamoDB.class) final Closure<PutDynamoDB> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<PutDynamoDB, PutDynamoDB> configurator) {
    return configurator.apply(new PutDynamoDB(properties)).build();
  }
