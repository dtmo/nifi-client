...
public final class PublishKafkaRecord_0_10 {
  /**
   * The component type name.
   */
  public static final String COMPONENT_TYPE = "org.apache.nifi.processors.kafka.pubsub.PublishKafkaRecord_0_10";
  ...
  public PublishKafkaRecord_0_10() {
    this.properties = new HashMap<>();
  }

  public PublishKafkaRecord_0_10(final Map<String, String> properties) {
   ...
   * A comma-separated list of known Kafka Brokers in the format <host>:<port>
   */
  public final PublishKafkaRecord_0_10 setBootstrapServers(final String bootstrapServers) {
   ...
   * A comma-separated list of known Kafka Brokers in the format <host>:<port>
   */
  public final PublishKafkaRecord_0_10 removeBootstrapServers() {
   ...
   * The name of the Kafka Topic to publish to.
   */
  public final PublishKafkaRecord_0_10 setTopic(final String topic) {
   ...
   * The name of the Kafka Topic to publish to.
   */
  public final PublishKafkaRecord_0_10 removeTopic() {
   ...
   * The Record Reader to use for incoming FlowFiles
   */
  public final PublishKafkaRecord_0_10 setRecordReader(final String recordReader) {
   ...
   * The Record Reader to use for incoming FlowFiles
   */
  public final PublishKafkaRecord_0_10 removeRecordReader() {
   ...
   * The Record Writer to use in order to serialize the data before sending to Kafka
   */
  public final PublishKafkaRecord_0_10 setRecordWriter(final String recordWriter) {
   ...
   * The Record Writer to use in order to serialize the data before sending to Kafka
   */
  public final PublishKafkaRecord_0_10 removeRecordWriter() {
   ...
   * Protocol used to communicate with brokers. Corresponds to Kafka's 'security.protocol' property.
   */
  public final PublishKafkaRecord_0_10 setSecurityProtocol(final String securityProtocol) {
   ...
   * Protocol used to communicate with brokers. Corresponds to Kafka's 'security.protocol' property.
   */
  public final PublishKafkaRecord_0_10 removeSecurityProtocol() {
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final PublishKafkaRecord_0_10 setKerberosCredentialsService(
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final PublishKafkaRecord_0_10 removeKerberosCredentialsService() {
   ...
   * The Kerberos principal name that Kafka runs as. This can be defined either in Kafka's JAAS config or in Kafka's config. Corresponds to Kafka's 'security.protocol' property.It is ignored unless one of the SASL options of the <Security Protocol> are selected.
   */
  public final PublishKafkaRecord_0_10 setSaslKerberosServiceName(
   ...
   * The Kerberos principal name that Kafka runs as. This can be defined either in Kafka's JAAS config or in Kafka's config. Corresponds to Kafka's 'security.protocol' property.It is ignored unless one of the SASL options of the <Security Protocol> are selected.
   */
  public final PublishKafkaRecord_0_10 removeSaslKerberosServiceName() {
   ...
   * The Kerberos principal that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final PublishKafkaRecord_0_10 setSaslKerberosPrincipal(
   ...
   * The Kerberos principal that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final PublishKafkaRecord_0_10 removeSaslKerberosPrincipal() {
   ...
   * The Kerberos keytab that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final PublishKafkaRecord_0_10 setSaslKerberosKeytab(final String saslKerberosKeytab) {
   ...
   * The Kerberos keytab that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final PublishKafkaRecord_0_10 removeSaslKerberosKeytab() {
   ...
   * Specifies the SSL Context Service to use for communicating with Kafka.
   */
  public final PublishKafkaRecord_0_10 setSslContextService(final String sslContextService) {
   ...
   * Specifies the SSL Context Service to use for communicating with Kafka.
   */
  public final PublishKafkaRecord_0_10 removeSslContextService() {
   ...
   * Specifies the requirement for guaranteeing that a message is sent to Kafka. Corresponds to Kafka's 'acks' property.
   */
  public final PublishKafkaRecord_0_10 setAcks(final String acks) {
   ...
   * Specifies the requirement for guaranteeing that a message is sent to Kafka. Corresponds to Kafka's 'acks' property.
   */
  public final PublishKafkaRecord_0_10 removeAcks() {
   ...
   * The name of a field in the Input Records that should be used as the Key for the Kafka message.
   */
  public final PublishKafkaRecord_0_10 setMessageKeyField(final String messageKeyField) {
   ...
   * The name of a field in the Input Records that should be used as the Key for the Kafka message.
   */
  public final PublishKafkaRecord_0_10 removeMessageKeyField() {
   ...
   * The maximum size of a request in bytes. Corresponds to Kafka's 'max.request.size' property and defaults to 1 MB (1048576).
   */
  public final PublishKafkaRecord_0_10 setMaxRequestSize(final String maxRequestSize) {
   ...
   * The maximum size of a request in bytes. Corresponds to Kafka's 'max.request.size' property and defaults to 1 MB (1048576).
   */
  public final PublishKafkaRecord_0_10 removeMaxRequestSize() {
   ...
   * After sending a message to Kafka, this indicates the amount of time that we are willing to wait for a response from Kafka. If Kafka does not acknowledge the message within this time period, the FlowFile will be routed to 'failure'.
   */
  public final PublishKafkaRecord_0_10 setAckWaitTime(final String ackWaitTime) {
   ...
   * After sending a message to Kafka, this indicates the amount of time that we are willing to wait for a response from Kafka. If Kafka does not acknowledge the message within this time period, the FlowFile will be routed to 'failure'.
   */
  public final PublishKafkaRecord_0_10 removeAckWaitTime() {
   ...
   * The amount of time publisher will wait to obtain metadata or wait for the buffer to flush during the 'send' call before failing the entire 'send' call. Corresponds to Kafka's 'max.block.ms' property
   */
  public final PublishKafkaRecord_0_10 setMaxBlockMs(final String maxBlockMs) {
   ...
   * The amount of time publisher will wait to obtain metadata or wait for the buffer to flush during the 'send' call before failing the entire 'send' call. Corresponds to Kafka's 'max.block.ms' property
   */
  public final PublishKafkaRecord_0_10 removeMaxBlockMs() {
   ...
   * Specifies which class to use to compute a partition id for a message. Corresponds to Kafka's 'partitioner.class' property.
   */
  public final PublishKafkaRecord_0_10 setPartitionerClass(final String partitionerClass) {
   ...
   * Specifies which class to use to compute a partition id for a message. Corresponds to Kafka's 'partitioner.class' property.
   */
  public final PublishKafkaRecord_0_10 removePartitionerClass() {
   ...
   * This parameter allows you to specify the compression codec for all data generated by this producer.
   */
  public final PublishKafkaRecord_0_10 setCompressionType(final String compressionType) {
   ...
   * This parameter allows you to specify the compression codec for all data generated by this producer.
   */
  public final PublishKafkaRecord_0_10 removeCompressionType() {
  ...
  public final PublishKafkaRecord_0_10 setDynamicProperty(final String name, final String value) {
    properties.put(name, value);
    return this;
  }

  public final PublishKafkaRecord_0_10 removeDynamicProperty(final String name) {
  ...
  public static final Map<String, String> build(
      final Function<PublishKafkaRecord_0_10, PublishKafkaRecord_0_10> configurator) {
    return configurator.apply(new PublishKafkaRecord_0_10()).build();
  }

  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = PublishKafkaRecord_0_10.class) final Closure<PublishKafkaRecord_0_10> closure) {
    return build(c -> {
      final Closure<com.tibtech.nifi.processors.kafka.pubsub.PublishKafkaRecord_0_10> code = closure.rehydrate(c, com.tibtech.nifi.processors.kafka.pubsub.PublishKafkaRecord_0_10.class, com.tibtech.nifi.processors.kafka.pubsub.PublishKafkaRecord_0_10.class);
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<PublishKafkaRecord_0_10, PublishKafkaRecord_0_10> configurator) {
    return configurator.apply(new PublishKafkaRecord_0_10(properties)).build();
  }
