...
public final class QueryElasticsearchHttp {
   ...
   */
  public static final String COMPONENT_TYPE = "org.apache.nifi.processors.elasticsearch.QueryElasticsearchHttp";
   ...
   */
  public static final String ROUTING_QUERY_INFO_STRATEGY_PROPERTY = "routing-query-info-strategy";
   ...
   * Max wait time for the connection to the Elasticsearch REST API.
   */
  public final QueryElasticsearchHttp setElasticsearchHttpConnectTimeout(
   ...
   * Max wait time for a response from the Elasticsearch REST API.
   */
  public final QueryElasticsearchHttp setElasticsearchHttpResponseTimeout(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final QueryElasticsearchHttp setProxyConfigurationService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final QueryElasticsearchHttp removeProxyConfigurationService() {
   ...
   * The fully qualified hostname or IP address of the proxy server
   */
  public final QueryElasticsearchHttp setElasticsearchHttpProxyHost(
   ...
   * The fully qualified hostname or IP address of the proxy server
   */
  public final QueryElasticsearchHttp removeElasticsearchHttpProxyHost() {
   ...
   * The port of the proxy server
   */
  public final QueryElasticsearchHttp setElasticsearchHttpProxyPort(
   ...
   * The port of the proxy server
   */
  public final QueryElasticsearchHttp removeElasticsearchHttpProxyPort() {
   ...
   * Proxy Username
   */
  public final QueryElasticsearchHttp setProxyUsername(final String proxyUsername) {
   ...
   * Proxy Username
   */
  public final QueryElasticsearchHttp removeProxyUsername() {
   ...
   * Proxy Password
   */
  public final QueryElasticsearchHttp setProxyPassword(final String proxyPassword) {
   ...
   * Proxy Password
   */
  public final QueryElasticsearchHttp removeProxyPassword() {
   ...
   * Specifies when to generate and route Query Info after a successful query
   */
  public final String getRoutingQueryInfoStrategy() {
    return properties.get(ROUTING_QUERY_INFO_STRATEGY_PROPERTY);
  }

  /**
   * Specifies when to generate and route Query Info after a successful query
   */
  public final QueryElasticsearchHttp setRoutingQueryInfoStrategy(
      final String routingQueryInfoStrategy) {
    properties.put(ROUTING_QUERY_INFO_STRATEGY_PROPERTY, routingQueryInfoStrategy);
    return this;
  }
   ...
   * Specifies when to generate and route Query Info after a successful query
   */
  public final QueryElasticsearchHttp removeRoutingQueryInfoStrategy() {
    properties.remove(ROUTING_QUERY_INFO_STRATEGY_PROPERTY);
    return this;
  }
