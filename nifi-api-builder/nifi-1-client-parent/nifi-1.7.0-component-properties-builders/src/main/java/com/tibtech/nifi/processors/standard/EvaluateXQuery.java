...
public final class EvaluateXQuery {
   ...
   */
  public static final String VALIDATE_DTD_PROPERTY = "Validate DTD";
   ...
   * Specifies whether or not the XML content should be validated against the DTD.
   */
  public final String getValidateDtd() {
    return properties.get(VALIDATE_DTD_PROPERTY);
  }

  /**
   * Specifies whether or not the XML content should be validated against the DTD.
   */
  public final EvaluateXQuery setValidateDtd(final String validateDtd) {
    properties.put(VALIDATE_DTD_PROPERTY, validateDtd);
    return this;
  }
   ...
   * Specifies whether or not the XML content should be validated against the DTD.
   */
  public final EvaluateXQuery removeValidateDtd() {
    properties.remove(VALIDATE_DTD_PROPERTY);
    return this;
  }
