...
public class InvokerTypeSpecBuilderFactory
{
	...
	public static InvokerTypeSpecBuilder createInvokerTypeSpecBuilder(
			...
			final Class<?> responseType) throws IntrospectionException
	{
		...
		return invokerTypeSpecBuilder;
	}

	public static InvokerTypeSpecBuilder create(final Class<? extends ApplicationResource> applicationResourceClass,
			final Method restResourceMethod) throws IntrospectionException
	{
		final ApiOperation apiOperation = restResourceMethod.getAnnotation(ApiOperation.class);
		final Class<?> invokerResponseType = apiOperation.response();

		final InvokerTypeSpecBuilder invokerTypeSpecBuilder = createInvokerTypeSpecBuilder(applicationResourceClass,
				restResourceMethod, invokerResponseType);
		...
		for (final Class<? extends ApplicationResource> applicationResourceClass : applicationResources)
		{
			...
			if (classResourcePathAnnotation != null)
			{
				...
				for (Method restApiMethod : restApiMethods)
				{
					...
					final TypeSpec invokerTypeSpec = invokerTypeSpecBuilder.build();
