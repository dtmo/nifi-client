...
public final class ConnectableDTOBuilder {
   ...
   * The ID of the corresponding component that is under version control
   */
  public ConnectableDTOBuilder setVersionedComponentId(final String versionedComponentId) {
  ...
  public ConnectableDTO build() {
    ...
    connectableDTO.setVersionedComponentId(versionedComponentId);
  ...
  public static ConnectableDTOBuilder of(final ConnectableDTO connectableDTO) {
    ...
    connectableDTOBuilder.setVersionedComponentId(connectableDTO.getVersionedComponentId());
