...
public final class GetHTMLElement {
  ...
  /**
   * Base URL for the HTML page being parsed. This URL will be used to resolve an absolute URL when an attribute value is extracted from a HTML element.
   */
