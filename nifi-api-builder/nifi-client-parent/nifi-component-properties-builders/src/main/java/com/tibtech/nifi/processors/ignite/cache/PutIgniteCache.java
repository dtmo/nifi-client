...
public final class PutIgniteCache {
   ...
   * Ignite spring configuration file, <path>/<ignite-configuration>.xml. If the configuration file is not provided, default Ignite configuration configuration is used which binds to 127.0.0.1:47500..47509
   */
  public final PutIgniteCache setIgniteSpringPropertiesXmlFile(final String igniteSpringPropertiesXmlFile) {
   ...
   * A FlowFile attribute, or attribute expression used for determining Ignite cache key for the Flow File content
   */
  public final PutIgniteCache setIgniteCacheEntryIdentifier(final String igniteCacheEntryIdentifier) {
   ...
   * Data streamer per node parallelism
   */
  public final PutIgniteCache setDataStreamerPerNodeParallelOperations(final String dataStreamerPerNodeParallelOperations) {
   ...
   * Data streamer per node buffer size (1-500).
   */
  public final PutIgniteCache setDataStreamerPerNodeBufferSize(final String dataStreamerPerNodeBufferSize) {
   ...
   * Data streamer flush interval in millis seconds
   */
  public final PutIgniteCache setDataStreamerAutoFlushFrequencyInMillis(final String dataStreamerAutoFlushFrequencyInMillis) {
  ...
  public static final Map<String, String> build(final Function<PutIgniteCache, PutIgniteCache> configurator) {
