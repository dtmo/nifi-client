...
public final class PutKinesisStream {
   ...
   * The partition key attribute.  If it is not set, a random value is used
   */
  public final PutKinesisStream setAmazonKinesisStreamPartitionKey(
      final String amazonKinesisStreamPartitionKey) {
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final PutKinesisStream setAwsCredentialsProviderService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutKinesisStream setProxyConfigurationService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutKinesisStream removeProxyConfigurationService() {
   ...
   * Proxy username
   */
  public final PutKinesisStream setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final PutKinesisStream removeProxyUserName() {
   ...
   * Proxy password
   */
  public final PutKinesisStream setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final PutKinesisStream removeProxyUserPassword() {
   ...
   * Endpoint URL to use instead of the AWS default including scheme, host, port, and path. The AWS libraries select an endpoint URL based on the AWS region, but this property overrides the selected endpoint URL, allowing use with other S3-compatible endpoints.
   */
  public final PutKinesisStream setEndpointOverrideUrl(final String endpointOverrideUrl) {
   ...
   * Endpoint URL to use instead of the AWS default including scheme, host, port, and path. The AWS libraries select an endpoint URL based on the AWS region, but this property overrides the selected endpoint URL, allowing use with other S3-compatible endpoints.
   */
  public final PutKinesisStream removeEndpointOverrideUrl() {
