...
public final class ExtractImageMetadata {
  ...
  public static final Map<String, String> build(final Function<ExtractImageMetadata, ExtractImageMetadata> configurator) {
    return configurator.apply(new ExtractImageMetadata()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = ExtractImageMetadata.class) final Closure<ExtractImageMetadata> closure) {
    return build(c -> {
