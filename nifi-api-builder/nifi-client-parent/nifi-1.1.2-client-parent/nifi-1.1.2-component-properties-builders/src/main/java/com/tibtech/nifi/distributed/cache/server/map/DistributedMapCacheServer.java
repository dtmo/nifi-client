...
public final class DistributedMapCacheServer {
   ...
   * If specified, the cache will be persisted in the given directory; if not specified, the cache will be in-memory only
   */
  public final DistributedMapCacheServer setPersistenceDirectory(final String persistenceDirectory) {
  ...
  public static final Map<String, String> build(final Function<DistributedMapCacheServer, DistributedMapCacheServer> configurator) {
