...
public final class PutHTMLElement {
   ...
   * Base URL for the HTML page being parsed.
   */
  public final PutHTMLElement setUrl(final String url) {
   ...
   * Base URL for the HTML page being parsed.
   */
  public final PutHTMLElement removeUrl() {
  ...
  public static final Map<String, String> build(final Function<PutHTMLElement, PutHTMLElement> configurator) {
