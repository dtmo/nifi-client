...
public final class ProcessorStatusSnapshotDTOBuilder {
   ...
   * Indicates the node where the process will execute.
   */
  public ProcessorStatusSnapshotDTOBuilder setExecutionNode(final String executionNode) {
  ...
  public ProcessorStatusSnapshotDTO build() {
    ...
    processorStatusSnapshotDTO.setExecutionNode(executionNode);
    ...
    processorStatusSnapshotDTO.setTerminatedThreadCount(terminatedThreadCount);
  ...
  public static ProcessorStatusSnapshotDTOBuilder of(
    ...
    processorStatusSnapshotDTOBuilder.setExecutionNode(processorStatusSnapshotDTO.getExecutionNode());
    ...
    processorStatusSnapshotDTOBuilder.setTerminatedThreadCount(processorStatusSnapshotDTO.getTerminatedThreadCount());
