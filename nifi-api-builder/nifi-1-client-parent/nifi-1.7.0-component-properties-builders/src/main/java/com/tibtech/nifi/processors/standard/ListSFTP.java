...
public final class ListSFTP {
   ...
   * Specify timestamp precision at the target system. Since this processor uses timestamp of entities to decide which should be listed, it is crucial to use the right timestamp precision.
   */
  public final ListSFTP setTargetSystemTimestampPrecision(
   ...
   * Specify timestamp precision at the target system. Since this processor uses timestamp of entities to decide which should be listed, it is crucial to use the right timestamp precision.
   */
  public final ListSFTP removeTargetSystemTimestampPrecision() {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS + AuthN
   */
  public final ListSFTP setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS + AuthN
   */
  public final ListSFTP removeProxyConfigurationService() {
   ...
   * Proxy type used for file transfers
   */
  public final ListSFTP setProxyType(final String proxyType) {
   ...
   * Proxy type used for file transfers
   */
  public final ListSFTP removeProxyType() {
   ...
   * The fully qualified hostname or IP address of the proxy server
   */
  public final ListSFTP setProxyHost(final String proxyHost) {
   ...
   * The fully qualified hostname or IP address of the proxy server
   */
  public final ListSFTP removeProxyHost() {
   ...
   * The port of the proxy server
   */
  public final ListSFTP setProxyPort(final String proxyPort) {
   ...
   * The port of the proxy server
   */
  public final ListSFTP removeProxyPort() {
   ...
   * Http Proxy Username
   */
  public final ListSFTP setHttpProxyUsername(final String httpProxyUsername) {
   ...
   * Http Proxy Username
   */
  public final ListSFTP removeHttpProxyUsername() {
   ...
   * Http Proxy Password
   */
  public final ListSFTP setHttpProxyPassword(final String httpProxyPassword) {
   ...
   * Http Proxy Password
   */
  public final ListSFTP removeHttpProxyPassword() {
