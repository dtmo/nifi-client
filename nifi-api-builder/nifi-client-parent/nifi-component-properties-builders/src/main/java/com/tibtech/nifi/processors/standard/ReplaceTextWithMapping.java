...
public final class ReplaceTextWithMapping {
   ...
   * The polling interval in seconds to check for updates to the mapping file. The default is 60s.
   */
  public final ReplaceTextWithMapping setMappingFileRefreshInterval(final String mappingFileRefreshInterval) {
  ...
  public static final Map<String, String> build(final Function<ReplaceTextWithMapping, ReplaceTextWithMapping> configurator) {
