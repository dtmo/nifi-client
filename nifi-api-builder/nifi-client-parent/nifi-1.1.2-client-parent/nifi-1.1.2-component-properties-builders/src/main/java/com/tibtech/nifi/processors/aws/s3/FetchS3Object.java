...
public final class FetchS3Object {
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final FetchS3Object setAwsCredentialsProviderService(final String awsCredentialsProviderService) {
  ...
  public static final Map<String, String> build(final Function<FetchS3Object, FetchS3Object> configurator) {
