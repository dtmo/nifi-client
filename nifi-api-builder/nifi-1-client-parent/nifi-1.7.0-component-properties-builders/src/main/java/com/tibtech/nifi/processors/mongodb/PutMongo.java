...
public final class PutMongo {
  ...
  /**
   * Key name used to build the update query criteria; this property is valid only when using update mode, otherwise it is ignored. Example: _id
   */
  public static final String UPDATE_QUERY_KEY_PROPERTY = "Update Query Key";

  /**
   * Specify a full MongoDB query to be used for the lookup query to do an update/upsert.
   */
  public static final String PUTMONGO_UPDATE_QUERY_PROPERTY = "putmongo-update-query";

  /**
   * Choose an update mode. You can either supply a JSON document to use as a direct replacement or specify a document that contains update operators like $set and $unset
   */
  public static final String PUT_MONGO_UPDATE_MODE_PROPERTY = "put-mongo-update-mode";
   ...
   * Specify a full MongoDB query to be used for the lookup query to do an update/upsert.
   */
  public final String getPutmongoUpdateQuery() {
    return properties.get(PUTMONGO_UPDATE_QUERY_PROPERTY);
  }

  /**
   * Specify a full MongoDB query to be used for the lookup query to do an update/upsert.
   */
  public final PutMongo setPutmongoUpdateQuery(final String putmongoUpdateQuery) {
    properties.put(PUTMONGO_UPDATE_QUERY_PROPERTY, putmongoUpdateQuery);
    return this;
  }
   ...
   * Specify a full MongoDB query to be used for the lookup query to do an update/upsert.
   */
  public final PutMongo removePutmongoUpdateQuery() {
    properties.remove(PUTMONGO_UPDATE_QUERY_PROPERTY);
    return this;
  }
   ...
   * Choose an update mode. You can either supply a JSON document to use as a direct replacement or specify a document that contains update operators like $set and $unset
   */
  public final String getPutMongoUpdateMode() {
    return properties.get(PUT_MONGO_UPDATE_MODE_PROPERTY);
  }

  /**
   * Choose an update mode. You can either supply a JSON document to use as a direct replacement or specify a document that contains update operators like $set and $unset
   */
  public final PutMongo setPutMongoUpdateMode(final String putMongoUpdateMode) {
    properties.put(PUT_MONGO_UPDATE_MODE_PROPERTY, putMongoUpdateMode);
    return this;
  }
   ...
   * Choose an update mode. You can either supply a JSON document to use as a direct replacement or specify a document that contains update operators like $set and $unset
   */
  public final PutMongo removePutMongoUpdateMode() {
    properties.remove(PUT_MONGO_UPDATE_MODE_PROPERTY);
    return this;
  }
