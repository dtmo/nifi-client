...
public final class PutFTP {
   ...
   */
  public static final String FTP_USE_UTF_8_PROPERTY = "ftp-use-utf8";
  ...
  public PutFTP(final Map<String, String> properties) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final PutFTP setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final PutFTP removeProxyConfigurationService() {
   ...
   * Set the internal buffer size for buffered data streams
   */
  public final PutFTP setInternalBufferSize(final String internalBufferSize) {
   ...
   * Set the internal buffer size for buffered data streams
   */
  public final PutFTP removeInternalBufferSize() {
   ...
   * Tells the client to use UTF-8 encoding when processing files and filenames. If set to true, the server must also support UTF-8 encoding.
   */
  public final String getFtpUseUtf8() {
    return properties.get(FTP_USE_UTF_8_PROPERTY);
  }

  /**
   * Tells the client to use UTF-8 encoding when processing files and filenames. If set to true, the server must also support UTF-8 encoding.
   */
  public final PutFTP setFtpUseUtf8(final String ftpUseUtf8) {
    properties.put(FTP_USE_UTF_8_PROPERTY, ftpUseUtf8);
    return this;
  }
   ...
   * Tells the client to use UTF-8 encoding when processing files and filenames. If set to true, the server must also support UTF-8 encoding.
   */
  public final PutFTP removeFtpUseUtf8() {
    properties.remove(FTP_USE_UTF_8_PROPERTY);
    return this;
  }
  ...
  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = PutFTP.class) final Closure<PutFTP> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<PutFTP, PutFTP> configurator) {
    return configurator.apply(new PutFTP(properties)).build();
  }
