...
public final class GetHDFSEvents {
   ...
   */
  public static final String COMPONENT_TYPE = "org.apache.nifi.processors.hadoop.inotify.GetHDFSEvents";
   ...
   * A file or comma separated list of files which contains the Hadoop file system configuration. Without this, Hadoop will search the classpath for a 'core-site.xml' and 'hdfs-site.xml' file or will revert to a default configuration. To use swebhdfs, see 'Additional Details' section of PutHDFS's documentation.
   */
  public final GetHDFSEvents setHadoopConfigurationResources(
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final GetHDFSEvents setKerberosCredentialsService(
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final GetHDFSEvents removeKerberosCredentialsService() {
   ...
   * A comma-separated list of paths to files and/or directories that will be added to the classpath. When specifying a directory, all files with in the directory will be added to the classpath, but further sub-directories will not be included.
   */
  public final GetHDFSEvents setAdditionalClasspathResources(
   ...
   * According to the HDFS admin API for event polling it is good to retry at least a few times. This number defines how many times the poll will be retried if it throws an IOException.
   */
  public final GetHDFSEvents setIoExceptionRetriesDuringEventPolling(
      final String ioExceptionRetriesDuringEventPolling) {
