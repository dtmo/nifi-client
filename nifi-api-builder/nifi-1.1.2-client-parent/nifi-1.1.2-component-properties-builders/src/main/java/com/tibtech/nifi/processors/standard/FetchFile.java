...
public final class FetchFile {
  ...
  /**
   * Log level to use in case user damian does not have sufficient permissions to read the file
   */
   ...
   * Log level to use in case user damian does not have sufficient permissions to read the file
   */
  public final FetchFile setLogLevelWhenPermissionDenied(final String logLevelWhenPermissionDenied) {
