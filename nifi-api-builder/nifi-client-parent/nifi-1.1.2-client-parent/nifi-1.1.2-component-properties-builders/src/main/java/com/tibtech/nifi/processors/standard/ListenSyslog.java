...
public final class ListenSyslog {
  ...
  /**
   * Specifies the character set of the Syslog messages
   */
  ...
  public static final Map<String, String> build(final Function<ListenSyslog, ListenSyslog> configurator) {
    return configurator.apply(new ListenSyslog()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = ListenSyslog.class) final Closure<ListenSyslog> closure) {
    return build(c -> {
