...
public class RuleResource
{
	...
	@ApiOperation(value = "", response = EvaluationContextEntity.class)
	@GET
		...
		if (requestEntity.getFlowFilePolicy() != null)
		{
			...
			catch (final IllegalArgumentException iae)
			{
				throw new WebApplicationException(iae,
						badRequest("The specified matching strategy is unknown: " + requestEntity.getFlowFilePolicy()));
			}
		}
	...
	@ApiOperation(value = "", response = RuleEntity.class)
	@POST
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Path("/rules")
	...
	@ApiOperation(value = "", response = ConditionEntity.class)
	@POST
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	...
	@ApiOperation(value = "", response = ActionEntity.class)
	@POST
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Path("/rules/actions")
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Path("/rules/{id}")
	public Response getRule(@PathParam("id") final String ruleId, @QueryParam("processorId") final String processorId,
	...
	@ApiOperation(value = "", response = RulesEntity.class)
	@GET
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Path("/rules")
