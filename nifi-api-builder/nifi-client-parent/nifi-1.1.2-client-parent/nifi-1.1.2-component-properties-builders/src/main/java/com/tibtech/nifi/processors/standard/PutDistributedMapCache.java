...
public final class PutDistributedMapCache {
   ...
   * The Controller Service that is used to cache flow files
   */
  public final PutDistributedMapCache setDistributedCacheService(final String distributedCacheService) {
  ...
  public static final Map<String, String> build(final Function<PutDistributedMapCache, PutDistributedMapCache> configurator) {
