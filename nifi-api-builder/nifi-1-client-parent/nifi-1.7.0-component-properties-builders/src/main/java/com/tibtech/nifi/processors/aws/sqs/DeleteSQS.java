...
public final class DeleteSQS {
   ...
   */
  public static final String RECEIPT_HANDLE_PROPERTY = "Receipt Handle";
  ...
  public final String getReceiptHandle() {
    return properties.get(RECEIPT_HANDLE_PROPERTY);
  }

  /**
   * The identifier that specifies the receipt of the message
   */
  public final DeleteSQS setReceiptHandle(final String receiptHandle) {
    properties.put(RECEIPT_HANDLE_PROPERTY, receiptHandle);
    return this;
  }
   ...
   * The identifier that specifies the receipt of the message
   */
  public final DeleteSQS removeReceiptHandle() {
    properties.remove(RECEIPT_HANDLE_PROPERTY);
    return this;
  }
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final DeleteSQS setAwsCredentialsProviderService(
