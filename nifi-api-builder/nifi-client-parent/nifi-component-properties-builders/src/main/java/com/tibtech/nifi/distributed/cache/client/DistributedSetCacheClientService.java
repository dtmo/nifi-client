...
public final class DistributedSetCacheClientService {
   ...
   * The name of the server that is running the DistributedSetCacheServer service
   */
  public final DistributedSetCacheClientService setServerHostname(final String serverHostname) {
   ...
   * The name of the server that is running the DistributedSetCacheServer service
   */
  public final DistributedSetCacheClientService removeServerHostname() {
   ...
   * The port on the remote server that is to be used when communicating with the DistributedSetCacheServer service
   */
  public final DistributedSetCacheClientService setServerPort(final String serverPort) {
   ...
   * The port on the remote server that is to be used when communicating with the DistributedSetCacheServer service
   */
  public final DistributedSetCacheClientService removeServerPort() {
   ...
   * If specified, indicates the SSL Context Service that is used to communicate with the remote server. If not specified, communications will not be encrypted
   */
  public final DistributedSetCacheClientService setSslContextService(final String sslContextService) {
   ...
   * If specified, indicates the SSL Context Service that is used to communicate with the remote server. If not specified, communications will not be encrypted
   */
  public final DistributedSetCacheClientService removeSslContextService() {
   ...
   * Specifices how long to wait when communicating with the remote server before determining that there is a communications failure if data cannot be sent or received
   */
  public final DistributedSetCacheClientService setCommunicationsTimeout(final String communicationsTimeout) {
   ...
   * Specifices how long to wait when communicating with the remote server before determining that there is a communications failure if data cannot be sent or received
   */
  public final DistributedSetCacheClientService removeCommunicationsTimeout() {
  ...
  public final DistributedSetCacheClientService setDynamicProperty(final String name,
      final String value) {
    properties.put(name, value);
    return this;
  }

  public final DistributedSetCacheClientService removeDynamicProperty(final String name) {
  ...
  public static final Map<String, String> build(final Function<DistributedSetCacheClientService, DistributedSetCacheClientService> configurator) {
    return configurator.apply(new DistributedSetCacheClientService()).build();
  }
