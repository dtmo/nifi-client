...
public final class DebugFlow {
   ...
   */
  public static final String ON_TRIGGER_PAUSE_TIME_PROPERTY = "OnTrigger Pause Time";

  /**
   * Specifies how long the processor should sleep in the customValidate() method
   */
  public static final String CUSTOM_VALIDATE_PAUSE_TIME_PROPERTY = "CustomValidate Pause Time";
   ...
   */
  public static final String IGNORE_INTERRUPTS_WHEN_PAUSED_PROPERTY = "Ignore Interrupts When Paused";
   ...
   * Number of FlowFiles to roll back and yield.
   */
  public final DebugFlow setFlowFileRollbackYieldIterations(
      final String flowFileRollbackYieldIterations) {
   ...
   * Number of FlowFiles to roll back with penalty.
   */
  public final DebugFlow setFlowFileRollbackPenaltyIterations(
      final String flowFileRollbackPenaltyIterations) {
   ...
   * Number of times to throw NPE exception if no FlowFile.
   */
  public final DebugFlow setNoFlowFileExceptionIterations(
      final String noFlowFileExceptionIterations) {
   ...
   * Specifies how long the processor should sleep in the onTrigger() method, so that the processor can be forced to take a long time to perform its task
   */
  public final String getOnTriggerPauseTime() {
    return properties.get(ON_TRIGGER_PAUSE_TIME_PROPERTY);
  }

  /**
   * Specifies how long the processor should sleep in the onTrigger() method, so that the processor can be forced to take a long time to perform its task
   */
  public final DebugFlow setOnTriggerPauseTime(final String onTriggerPauseTime) {
    properties.put(ON_TRIGGER_PAUSE_TIME_PROPERTY, onTriggerPauseTime);
    return this;
  }
   ...
   * Specifies how long the processor should sleep in the onTrigger() method, so that the processor can be forced to take a long time to perform its task
   */
  public final DebugFlow removeOnTriggerPauseTime() {
    properties.remove(ON_TRIGGER_PAUSE_TIME_PROPERTY);
    return this;
  }
   ...
   * Specifies how long the processor should sleep in the customValidate() method
   */
  public final String getCustomValidatePauseTime() {
    return properties.get(CUSTOM_VALIDATE_PAUSE_TIME_PROPERTY);
  }

  /**
   * Specifies how long the processor should sleep in the customValidate() method
   */
  public final DebugFlow setCustomValidatePauseTime(final String customValidatePauseTime) {
    properties.put(CUSTOM_VALIDATE_PAUSE_TIME_PROPERTY, customValidatePauseTime);
    return this;
  }
   ...
   * Specifies how long the processor should sleep in the customValidate() method
   */
  public final DebugFlow removeCustomValidatePauseTime() {
    properties.remove(CUSTOM_VALIDATE_PAUSE_TIME_PROPERTY);
    return this;
  }
   ...
   * If the Processor's thread(s) are sleeping (due to one of the "Pause Time" properties above), and the thread is interrupted, this indicates whether the Processor should ignore the interrupt and continue sleeping or if it should allow itself to be interrupted.
   */
  public final String getIgnoreInterruptsWhenPaused() {
    return properties.get(IGNORE_INTERRUPTS_WHEN_PAUSED_PROPERTY);
  }

  /**
   * If the Processor's thread(s) are sleeping (due to one of the "Pause Time" properties above), and the thread is interrupted, this indicates whether the Processor should ignore the interrupt and continue sleeping or if it should allow itself to be interrupted.
   */
  public final DebugFlow setIgnoreInterruptsWhenPaused(final String ignoreInterruptsWhenPaused) {
    properties.put(IGNORE_INTERRUPTS_WHEN_PAUSED_PROPERTY, ignoreInterruptsWhenPaused);
    return this;
  }
   ...
   * If the Processor's thread(s) are sleeping (due to one of the "Pause Time" properties above), and the thread is interrupted, this indicates whether the Processor should ignore the interrupt and continue sleeping or if it should allow itself to be interrupted.
   */
  public final DebugFlow removeIgnoreInterruptsWhenPaused() {
    properties.remove(IGNORE_INTERRUPTS_WHEN_PAUSED_PROPERTY);
    return this;
  }
