package com.tibtech.nifi.processors.beats;
...
public final class ListenBeats {
  /**
   * The component type name.
   */
  public static final String COMPONENT_TYPE = "org.apache.nifi.processors.beats.ListenBeats";
  ...
  public ListenBeats(final Map<String, String> properties) {
   ...
   * The name of a local network interface to be used to restrict listening to a specific LAN.
   */
  public final ListenBeats setLocalNetworkInterface(final String localNetworkInterface) {
   ...
   * The name of a local network interface to be used to restrict listening to a specific LAN.
   */
  public final ListenBeats removeLocalNetworkInterface() {
   ...
   * The port to listen on for communication.
   */
  public final ListenBeats setPort(final String port) {
   ...
   * The port to listen on for communication.
   */
  public final ListenBeats removePort() {
   ...
   * The size of each buffer used to receive messages. Adjust this value appropriately based on the expected size of the incoming messages.
   */
  public final ListenBeats setReceiveBufferSize(final String receiveBufferSize) {
   ...
   * The size of each buffer used to receive messages. Adjust this value appropriately based on the expected size of the incoming messages.
   */
  public final ListenBeats removeReceiveBufferSize() {
   ...
   * The maximum size of the internal queue used to buffer messages being transferred from the underlying channel to the processor. Setting this value higher allows more messages to be buffered in memory during surges of incoming messages, but increases the total memory used by the processor.
   */
  public final ListenBeats setMaxSizeOfMessageQueue(final String maxSizeOfMessageQueue) {
   ...
   * The maximum size of the internal queue used to buffer messages being transferred from the underlying channel to the processor. Setting this value higher allows more messages to be buffered in memory during surges of incoming messages, but increases the total memory used by the processor.
   */
  public final ListenBeats removeMaxSizeOfMessageQueue() {
   ...
   * The maximum size of the socket buffer that should be used. This is a suggestion to the Operating System to indicate how big the socket buffer should be. If this value is set too low, the buffer may fill up before the data can be read, and incoming data will be dropped.
   */
  public final ListenBeats setMaxSizeOfSocketBuffer(final String maxSizeOfSocketBuffer) {
   ...
   * The maximum size of the socket buffer that should be used. This is a suggestion to the Operating System to indicate how big the socket buffer should be. If this value is set too low, the buffer may fill up before the data can be read, and incoming data will be dropped.
   */
  public final ListenBeats removeMaxSizeOfSocketBuffer() {
   ...
   * Specifies the character set of the received data.
   */
  public final ListenBeats setCharacterSet(final String characterSet) {
   ...
   * Specifies the character set of the received data.
   */
  public final ListenBeats removeCharacterSet() {
   ...
   * The maximum number of messages to add to a single FlowFile. If multiple messages are available, they will be concatenated along with the <Message Delimiter> up to this configured maximum number of messages
   */
  public final ListenBeats setMaxBatchSize(final String maxBatchSize) {
   ...
   * The maximum number of messages to add to a single FlowFile. If multiple messages are available, they will be concatenated along with the <Message Delimiter> up to this configured maximum number of messages
   */
  public final ListenBeats removeMaxBatchSize() {
   ...
   * Specifies the delimiter to place between messages when multiple messages are bundled together (see <Max Batch Size> property).
   */
  public final ListenBeats setMessageDelimiter(final String messageDelimiter) {
   ...
   * Specifies the delimiter to place between messages when multiple messages are bundled together (see <Max Batch Size> property).
   */
  public final ListenBeats removeMessageDelimiter() {
   ...
   * The maximum number of concurrent TCP connections to accept.
   */
  public final ListenBeats setMaxNumberOfTcpConnections(final String maxNumberOfTcpConnections) {
   ...
   * The maximum number of concurrent TCP connections to accept.
   */
  public final ListenBeats removeMaxNumberOfTcpConnections() {
   ...
   * The Controller Service to use in order to obtain an SSL Context. If this property is set, messages will be received over a secure connection.
   */
  public final ListenBeats setSslContextService(final String sslContextService) {
   ...
   * The Controller Service to use in order to obtain an SSL Context. If this property is set, messages will be received over a secure connection.
   */
  public final ListenBeats removeSslContextService() {
  ...
  public final ListenBeats setDynamicProperty(final String name, final String value) {
    properties.put(name, value);
    return this;
  }

  public final ListenBeats removeDynamicProperty(final String name) {
  ...
  public static final Map<String, String> build(
      final Function<ListenBeats, ListenBeats> configurator) {
    return configurator.apply(new ListenBeats()).build();
  }

  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = ListenBeats.class) final Closure<ListenBeats> closure) {
    return build(c -> {
      final Closure<com.tibtech.nifi.processors.beats.ListenBeats> code = closure.rehydrate(c, com.tibtech.nifi.processors.beats.ListenBeats.class, com.tibtech.nifi.processors.beats.ListenBeats.class);
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<ListenBeats, ListenBeats> configurator) {
    return configurator.apply(new ListenBeats(properties)).build();
  }
