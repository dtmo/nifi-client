...
public final class ConvertJSONToSQL {
   ...
   */
  public static final String JTS_QUOTED_TABLE_IDENTIFIERS_PROPERTY = "jts-quoted-table-identifiers";

  /**
   * The string to be prepended to the outgoing flow file attributes, such as <sql>.args.1.value, where <sql> is replaced with the specified value
   */
  public static final String JTS_SQL_PARAM_ATTR_PREFIX_PROPERTY = "jts-sql-param-attr-prefix";
   ...
   * Enabling this option will cause the table name to be quoted to support the use of special characters in the table name
   */
  public final String getJtsQuotedTableIdentifiers() {
    return properties.get(JTS_QUOTED_TABLE_IDENTIFIERS_PROPERTY);
  }

  /**
   * Enabling this option will cause the table name to be quoted to support the use of special characters in the table name
   */
  public final ConvertJSONToSQL setJtsQuotedTableIdentifiers(
      final String jtsQuotedTableIdentifiers) {
    properties.put(JTS_QUOTED_TABLE_IDENTIFIERS_PROPERTY, jtsQuotedTableIdentifiers);
    return this;
  }
   ...
   * Enabling this option will cause the table name to be quoted to support the use of special characters in the table name
   */
  public final ConvertJSONToSQL removeJtsQuotedTableIdentifiers() {
    properties.remove(JTS_QUOTED_TABLE_IDENTIFIERS_PROPERTY);
    return this;
  }
   ...
   * The string to be prepended to the outgoing flow file attributes, such as <sql>.args.1.value, where <sql> is replaced with the specified value
   */
  public final String getJtsSqlParamAttrPrefix() {
    return properties.get(JTS_SQL_PARAM_ATTR_PREFIX_PROPERTY);
  }

  /**
   * The string to be prepended to the outgoing flow file attributes, such as <sql>.args.1.value, where <sql> is replaced with the specified value
   */
  public final ConvertJSONToSQL setJtsSqlParamAttrPrefix(final String jtsSqlParamAttrPrefix) {
    properties.put(JTS_SQL_PARAM_ATTR_PREFIX_PROPERTY, jtsSqlParamAttrPrefix);
    return this;
  }
   ...
   * The string to be prepended to the outgoing flow file attributes, such as <sql>.args.1.value, where <sql> is replaced with the specified value
   */
  public final ConvertJSONToSQL removeJtsSqlParamAttrPrefix() {
    properties.remove(JTS_SQL_PARAM_ATTR_PREFIX_PROPERTY);
    return this;
  }
