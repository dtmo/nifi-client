...
public final class SiteToSiteMetricsReportingTask {
  /**
   * The component type name.
   */
  public static final String COMPONENT_TYPE = "org.apache.nifi.reporting.SiteToSiteMetricsReportingTask";
   ...
   */
  public static final String S_2_S_METRICS_HOSTNAME_PROPERTY = "s2s-metrics-hostname";

  /**
   * The Application ID to be included in the metrics
   */
  public static final String S_2_S_METRICS_APPLICATION_ID_PROPERTY = "s2s-metrics-application-id";
   ...
   */
  public static final String S_2_S_METRICS_FORMAT_PROPERTY = "s2s-metrics-format";
  ...
  public SiteToSiteMetricsReportingTask(final Map<String, String> properties) {
   ...
   * The URL of the destination NiFi instance to send data to, should be a comma-separated list of address in the format of http(s)://host:port/nifi.
   */
  public final SiteToSiteMetricsReportingTask setDestinationUrl(final String destinationUrl) {
   ...
   * The URL of the destination NiFi instance to send data to, should be a comma-separated list of address in the format of http(s)://host:port/nifi.
   */
  public final SiteToSiteMetricsReportingTask removeDestinationUrl() {
   ...
   * The name of the Input Port to deliver data to.
   */
  public final SiteToSiteMetricsReportingTask setInputPortName(final String inputPortName) {
   ...
   * The name of the Input Port to deliver data to.
   */
  public final SiteToSiteMetricsReportingTask removeInputPortName() {
   ...
   * The SSL Context Service to use when communicating with the destination. If not specified, communications will not be secure.
   */
  public final SiteToSiteMetricsReportingTask setSslContextService(final String sslContextService) {
   ...
   * The SSL Context Service to use when communicating with the destination. If not specified, communications will not be secure.
   */
  public final SiteToSiteMetricsReportingTask removeSslContextService() {
   ...
   * The URL of this instance to use in the Content URI of each event.
   */
  public final SiteToSiteMetricsReportingTask setInstanceUrl(final String instanceUrl) {
   ...
   * The URL of this instance to use in the Content URI of each event.
   */
  public final SiteToSiteMetricsReportingTask removeInstanceUrl() {
   ...
   * Indicates whether or not to compress the data being sent.
   */
  public final SiteToSiteMetricsReportingTask setCompressEvents(final String compressEvents) {
   ...
   * Indicates whether or not to compress the data being sent.
   */
  public final SiteToSiteMetricsReportingTask removeCompressEvents() {
   ...
   * Specifies how long to wait to a response from the destination before deciding that an error has occurred and canceling the transaction
   */
  public final SiteToSiteMetricsReportingTask setCommunicationsTimeout(
   ...
   * Specifies how long to wait to a response from the destination before deciding that an error has occurred and canceling the transaction
   */
  public final SiteToSiteMetricsReportingTask removeCommunicationsTimeout() {
   ...
   * Specifies which transport protocol to use for Site-to-Site communication.
   */
  public final SiteToSiteMetricsReportingTask setS2STransportProtocol(
   ...
   * Specifies which transport protocol to use for Site-to-Site communication.
   */
  public final SiteToSiteMetricsReportingTask removeS2STransportProtocol() {
   ...
   * Specify the proxy server's hostname to use. If not specified, HTTP traffics are sent directly to the target NiFi instance.
   */
  public final SiteToSiteMetricsReportingTask setS2SHttpProxyHostname(
   ...
   * Specify the proxy server's hostname to use. If not specified, HTTP traffics are sent directly to the target NiFi instance.
   */
  public final SiteToSiteMetricsReportingTask removeS2SHttpProxyHostname() {
   ...
   * Specify the proxy server's port number, optional. If not specified, default port 80 will be used.
   */
  public final SiteToSiteMetricsReportingTask setS2SHttpProxyPort(final String s2SHttpProxyPort) {
   ...
   * Specify the proxy server's port number, optional. If not specified, default port 80 will be used.
   */
  public final SiteToSiteMetricsReportingTask removeS2SHttpProxyPort() {
   ...
   * Specify an user name to connect to the proxy server, optional.
   */
  public final SiteToSiteMetricsReportingTask setS2SHttpProxyUsername(
   ...
   * Specify an user name to connect to the proxy server, optional.
   */
  public final SiteToSiteMetricsReportingTask removeS2SHttpProxyUsername() {
   ...
   * Specify an user password to connect to the proxy server, optional.
   */
  public final SiteToSiteMetricsReportingTask setS2SHttpProxyPassword(
   ...
   * Specify an user password to connect to the proxy server, optional.
   */
  public final SiteToSiteMetricsReportingTask removeS2SHttpProxyPassword() {
   ...
   * Specifies the Controller Service to use for writing out the records.
   */
  public final SiteToSiteMetricsReportingTask setRecordWriter(final String recordWriter) {
   ...
   * Specifies the Controller Service to use for writing out the records.
   */
  public final SiteToSiteMetricsReportingTask removeRecordWriter() {
   ...
   * The Hostname of this NiFi instance to be included in the metrics
   */
  public final String getS2SMetricsHostname() {
    return properties.get(S_2_S_METRICS_HOSTNAME_PROPERTY);
  }

  /**
   * The Hostname of this NiFi instance to be included in the metrics
   */
  public final SiteToSiteMetricsReportingTask setS2SMetricsHostname(
      final String s2SMetricsHostname) {
    properties.put(S_2_S_METRICS_HOSTNAME_PROPERTY, s2SMetricsHostname);
    return this;
  }
   ...
   * The Hostname of this NiFi instance to be included in the metrics
   */
  public final SiteToSiteMetricsReportingTask removeS2SMetricsHostname() {
    properties.remove(S_2_S_METRICS_HOSTNAME_PROPERTY);
    return this;
  }
   ...
   * The Application ID to be included in the metrics
   */
  public final String getS2SMetricsApplicationId() {
    return properties.get(S_2_S_METRICS_APPLICATION_ID_PROPERTY);
  }

  /**
   * The Application ID to be included in the metrics
   */
  public final SiteToSiteMetricsReportingTask setS2SMetricsApplicationId(
      final String s2SMetricsApplicationId) {
    properties.put(S_2_S_METRICS_APPLICATION_ID_PROPERTY, s2SMetricsApplicationId);
    return this;
  }
   ...
   * The Application ID to be included in the metrics
   */
  public final SiteToSiteMetricsReportingTask removeS2SMetricsApplicationId() {
    properties.remove(S_2_S_METRICS_APPLICATION_ID_PROPERTY);
    return this;
  }
   ...
   * The output format that will be used for the metrics. If Record Format is selected, a Record Writer must be provided. If Ambari Format is selected, the Record Writer property should be empty.
   */
  public final String getS2SMetricsFormat() {
    return properties.get(S_2_S_METRICS_FORMAT_PROPERTY);
  }

  /**
   * The output format that will be used for the metrics. If Record Format is selected, a Record Writer must be provided. If Ambari Format is selected, the Record Writer property should be empty.
   */
  public final SiteToSiteMetricsReportingTask setS2SMetricsFormat(final String s2SMetricsFormat) {
    properties.put(S_2_S_METRICS_FORMAT_PROPERTY, s2SMetricsFormat);
    return this;
  }
   ...
   * The output format that will be used for the metrics. If Record Format is selected, a Record Writer must be provided. If Ambari Format is selected, the Record Writer property should be empty.
   */
  public final SiteToSiteMetricsReportingTask removeS2SMetricsFormat() {
    properties.remove(S_2_S_METRICS_FORMAT_PROPERTY);
    return this;
  }
  ...
  public final SiteToSiteMetricsReportingTask setDynamicProperty(final String name,
      final String value) {
    properties.put(name, value);
    return this;
  }

  public final SiteToSiteMetricsReportingTask removeDynamicProperty(final String name) {
  ...
  public static final Map<String, String> build(
      final Function<SiteToSiteMetricsReportingTask, SiteToSiteMetricsReportingTask> configurator) {
    return configurator.apply(new SiteToSiteMetricsReportingTask()).build();
  }

  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = SiteToSiteMetricsReportingTask.class) final Closure<SiteToSiteMetricsReportingTask> closure) {
    return build(c -> {
      final Closure<com.tibtech.nifi.reporting.SiteToSiteMetricsReportingTask> code = closure.rehydrate(c, com.tibtech.nifi.reporting.SiteToSiteMetricsReportingTask.class, com.tibtech.nifi.reporting.SiteToSiteMetricsReportingTask.class);
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<SiteToSiteMetricsReportingTask, SiteToSiteMetricsReportingTask> configurator) {
    return configurator.apply(new SiteToSiteMetricsReportingTask(properties)).build();
  }
