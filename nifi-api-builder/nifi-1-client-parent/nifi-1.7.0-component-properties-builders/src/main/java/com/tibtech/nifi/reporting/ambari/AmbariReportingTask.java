...
public final class AmbariReportingTask {
  ...
  /**
   * If specified, the reporting task will send metrics about this process group only. If not, the root process group is used and global metrics are sent.
   */
   ...
   * If specified, the reporting task will send metrics about this process group only. If not, the root process group is used and global metrics are sent.
   */
  public final AmbariReportingTask setProcessGroupId(final String processGroupId) {
   ...
   * If specified, the reporting task will send metrics about this process group only. If not, the root process group is used and global metrics are sent.
   */
  public final AmbariReportingTask removeProcessGroupId() {
