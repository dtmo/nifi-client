...
public final class RuleEntityBuilder {
  ...
  public RuleEntity build() {
    ...
    ruleEntity.setDisconnectedNodeAcknowledged(disconnectedNodeAcknowledged);
  ...
  public static RuleEntityBuilder of(final RuleEntity ruleEntity) {
    ...
    ruleEntityBuilder.setDisconnectedNodeAcknowledged(ruleEntity.isDisconnectedNodeAcknowledged());
