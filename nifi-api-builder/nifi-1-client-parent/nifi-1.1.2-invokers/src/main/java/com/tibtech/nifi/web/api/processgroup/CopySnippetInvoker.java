 ...
 */
public final class CopySnippetInvoker extends AbstractInvoker<FlowSnippetEntity> {
  private String id;
  ...
  /**
   * The copy snippet request. */
  public final CopySnippetInvoker setCopySnippetRequestEntity(final CopySnippetRequestEntity copySnippetRequestEntity) {
  ...
  public final FlowSnippetEntity invoke() throws InvokerException {
    ...
    try {
      return handleResponse(response, FlowSnippetEntity.class);
    }
    finally {
      response.close();
    }
