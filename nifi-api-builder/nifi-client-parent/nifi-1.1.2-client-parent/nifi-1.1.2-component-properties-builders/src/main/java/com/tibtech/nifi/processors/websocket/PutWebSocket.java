...
public final class PutWebSocket {
   ...
   * A NiFi Expression to retrieve the id of a WebSocket ControllerService.
   */
  public final PutWebSocket setWebsocketControllerServiceId(final String websocketControllerServiceId) {
  ...
  public static final Map<String, String> build(final Function<PutWebSocket, PutWebSocket> configurator) {
