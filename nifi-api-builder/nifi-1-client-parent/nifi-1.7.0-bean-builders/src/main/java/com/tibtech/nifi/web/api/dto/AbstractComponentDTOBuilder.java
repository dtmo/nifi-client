...
public abstract class AbstractComponentDTOBuilder<T extends AbstractComponentDTOBuilder<T>> {
   ...
   * The ID of the corresponding component that is under version control
   */
  public T setVersionedComponentId(final String versionedComponentId) {
  ...
  protected static void setBuilderValues(
    ...
    abstractComponentDTOBuilder.setVersionedComponentId(componentDTO.getVersionedComponentId());
  }
}
