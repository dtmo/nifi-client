...
public final class ListenLumberjack {
   ...
   * The maximum number of concurrent TCP connections to accept.
   */
  public final ListenLumberjack setMaxNumberOfTcpConnections(final String maxNumberOfTcpConnections) {
  ...
  public static final Map<String, String> build(final Function<ListenLumberjack, ListenLumberjack> configurator) {
