...
public final class FetchFTP {
   ...
   * Used when 'Completion Strategy' is 'Move File'. Specifies whether or not the remote directory should be created if it does not exist.
   */
  public final FetchFTP setCreateDirectory(final String createDirectory) {
   ...
   * Used when 'Completion Strategy' is 'Move File'. Specifies whether or not the remote directory should be created if it does not exist.
   */
  public final FetchFTP removeCreateDirectory() {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final FetchFTP setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN, SOCKS
   */
  public final FetchFTP removeProxyConfigurationService() {
   ...
   * Set the internal buffer size for buffered data streams
   */
  public final FetchFTP setInternalBufferSize(final String internalBufferSize) {
   ...
   * Set the internal buffer size for buffered data streams
   */
  public final FetchFTP removeInternalBufferSize() {
