...
public final class PutS3Object {
   ...
   */
  public static final String S_3_OBJECT_TAGS_PREFIX_PROPERTY = "s3-object-tags-prefix";
   ...
   */
  public static final String S_3_OBJECT_REMOVE_TAGS_PREFIX_PROPERTY = "s3-object-remove-tags-prefix";
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final PutS3Object setAwsCredentialsProviderService(
   ...
   * Specifies the prefix which would be scanned against the incoming FlowFile's attributes and the matching attribute's name and value would be considered as the outgoing S3 object's Tag name and Tag value respectively. For Ex: If the incoming FlowFile carries the attributes tagS3country, tagS3PII, the tag prefix to be specified would be 'tagS3'
   */
  public final String getS3ObjectTagsPrefix() {
    return properties.get(S_3_OBJECT_TAGS_PREFIX_PROPERTY);
  }

  /**
   * Specifies the prefix which would be scanned against the incoming FlowFile's attributes and the matching attribute's name and value would be considered as the outgoing S3 object's Tag name and Tag value respectively. For Ex: If the incoming FlowFile carries the attributes tagS3country, tagS3PII, the tag prefix to be specified would be 'tagS3'
   */
  public final PutS3Object setS3ObjectTagsPrefix(final String s3ObjectTagsPrefix) {
    properties.put(S_3_OBJECT_TAGS_PREFIX_PROPERTY, s3ObjectTagsPrefix);
    return this;
  }
   ...
   * Specifies the prefix which would be scanned against the incoming FlowFile's attributes and the matching attribute's name and value would be considered as the outgoing S3 object's Tag name and Tag value respectively. For Ex: If the incoming FlowFile carries the attributes tagS3country, tagS3PII, the tag prefix to be specified would be 'tagS3'
   */
  public final PutS3Object removeS3ObjectTagsPrefix() {
    properties.remove(S_3_OBJECT_TAGS_PREFIX_PROPERTY);
    return this;
  }
   ...
   * If set to 'True', the value provided for 'Object Tags Prefix' will be removed from the attribute(s) and then considered as the Tag name. For ex: If the incoming FlowFile carries the attributes tagS3country, tagS3PII and the prefix is set to 'tagS3' then the corresponding tag values would be 'country' and 'PII'
   */
  public final String getS3ObjectRemoveTagsPrefix() {
    return properties.get(S_3_OBJECT_REMOVE_TAGS_PREFIX_PROPERTY);
  }

  /**
   * If set to 'True', the value provided for 'Object Tags Prefix' will be removed from the attribute(s) and then considered as the Tag name. For ex: If the incoming FlowFile carries the attributes tagS3country, tagS3PII and the prefix is set to 'tagS3' then the corresponding tag values would be 'country' and 'PII'
   */
  public final PutS3Object setS3ObjectRemoveTagsPrefix(final String s3ObjectRemoveTagsPrefix) {
    properties.put(S_3_OBJECT_REMOVE_TAGS_PREFIX_PROPERTY, s3ObjectRemoveTagsPrefix);
    return this;
  }
   ...
   * If set to 'True', the value provided for 'Object Tags Prefix' will be removed from the attribute(s) and then considered as the Tag name. For ex: If the incoming FlowFile carries the attributes tagS3country, tagS3PII and the prefix is set to 'tagS3' then the corresponding tag values would be 'country' and 'PII'
   */
  public final PutS3Object removeS3ObjectRemoveTagsPrefix() {
    properties.remove(S_3_OBJECT_REMOVE_TAGS_PREFIX_PROPERTY);
    return this;
  }
   ...
   * Specifies the interval at which existing multipart uploads in AWS S3 will be evaluated for ageoff.  When processor is triggered it will initiate the ageoff evaluation if this interval has been exceeded.
   */
  public final PutS3Object setMultipartUploadAgeOffInterval(
      final String multipartUploadAgeOffInterval) {
   ...
   * Specifies the maximum age for existing multipart uploads in AWS S3.  When the ageoff process occurs, any upload older than this threshold will be aborted.
   */
  public final PutS3Object setMultipartUploadMaxAgeThreshold(
      final String multipartUploadMaxAgeThreshold) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutS3Object setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutS3Object removeProxyConfigurationService() {
   ...
   * Proxy username
   */
  public final PutS3Object setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final PutS3Object removeProxyUserName() {
   ...
   * Proxy password
   */
  public final PutS3Object setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final PutS3Object removeProxyUserPassword() {
