...
public final class DistributedMapCacheClientService {
   ...
   * If specified, indicates the SSL Context Service that is used to communicate with the remote server. If not specified, communications will not be encrypted
   */
  public final DistributedMapCacheClientService setSslContextService(final String sslContextService) {
   ...
   * Specifies how long to wait when communicating with the remote server before determining that there is a communications failure if data cannot be sent or received
   */
  public final DistributedMapCacheClientService setCommunicationsTimeout(final String communicationsTimeout) {
  ...
  public static final Map<String, String> build(final Function<DistributedMapCacheClientService, DistributedMapCacheClientService> configurator) {
    return configurator.apply(new DistributedMapCacheClientService()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = DistributedMapCacheClientService.class) final Closure<DistributedMapCacheClientService> closure) {
    return build(c -> {
