...
public final class AttributesToJSON {
   ...
   */
  public static final String ATTRIBUTES_TO_JSON_REGEX_PROPERTY = "attributes-to-json-regex";
   ...
   * Regular expression that will be evaluated against the flow file attributes to select the matching attributes. This property can be used in combination with the attributes list property.
   */
  public final String getAttributesToJsonRegex() {
    return properties.get(ATTRIBUTES_TO_JSON_REGEX_PROPERTY);
  }

  /**
   * Regular expression that will be evaluated against the flow file attributes to select the matching attributes. This property can be used in combination with the attributes list property.
   */
  public final AttributesToJSON setAttributesToJsonRegex(final String attributesToJsonRegex) {
    properties.put(ATTRIBUTES_TO_JSON_REGEX_PROPERTY, attributesToJsonRegex);
    return this;
  }
   ...
   * Regular expression that will be evaluated against the flow file attributes to select the matching attributes. This property can be used in combination with the attributes list property.
   */
  public final AttributesToJSON removeAttributesToJsonRegex() {
    properties.remove(ATTRIBUTES_TO_JSON_REGEX_PROPERTY);
    return this;
  }
