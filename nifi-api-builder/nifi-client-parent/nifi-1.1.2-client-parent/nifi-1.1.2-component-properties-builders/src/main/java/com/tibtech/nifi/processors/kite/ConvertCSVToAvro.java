...
public final class ConvertCSVToAvro {
  ...
  public static final Map<String, String> build(final Function<ConvertCSVToAvro, ConvertCSVToAvro> configurator) {
    return configurator.apply(new ConvertCSVToAvro()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = ConvertCSVToAvro.class) final Closure<ConvertCSVToAvro> closure) {
    return build(c -> {
