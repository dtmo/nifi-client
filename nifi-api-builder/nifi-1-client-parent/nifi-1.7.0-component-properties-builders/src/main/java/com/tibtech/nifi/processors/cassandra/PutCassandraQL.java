...
public final class PutCassandraQL {
  ...
  public PutCassandraQL() {
    this.properties = new HashMap<>();
  }

  public PutCassandraQL(final Map<String, String> properties) {
  ...
  public static final Map<String, String> build(
      final Function<PutCassandraQL, PutCassandraQL> configurator) {
    return configurator.apply(new PutCassandraQL()).build();
  }

  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = PutCassandraQL.class) final Closure<PutCassandraQL> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<PutCassandraQL, PutCassandraQL> configurator) {
    return configurator.apply(new PutCassandraQL(properties)).build();
  }
