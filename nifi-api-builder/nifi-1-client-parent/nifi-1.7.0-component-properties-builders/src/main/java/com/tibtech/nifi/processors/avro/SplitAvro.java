...
public final class SplitAvro {
  ...
  public SplitAvro(final Map<String, String> properties) {
  ...
  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = SplitAvro.class) final Closure<SplitAvro> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<SplitAvro, SplitAvro> configurator) {
    return configurator.apply(new SplitAvro(properties)).build();
  }
