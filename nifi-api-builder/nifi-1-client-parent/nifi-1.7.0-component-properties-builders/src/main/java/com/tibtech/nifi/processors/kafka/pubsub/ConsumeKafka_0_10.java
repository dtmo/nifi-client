...
public final class ConsumeKafka_0_10 {
  ...
  public ConsumeKafka_0_10() {
    this.properties = new HashMap<>();
  }

  public ConsumeKafka_0_10(final Map<String, String> properties) {
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final ConsumeKafka_0_10 setKerberosCredentialsService(
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final ConsumeKafka_0_10 removeKerberosCredentialsService() {
   ...
   * The Kerberos principal that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final ConsumeKafka_0_10 setSaslKerberosPrincipal(final String saslKerberosPrincipal) {
   ...
   * The Kerberos principal that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final ConsumeKafka_0_10 removeSaslKerberosPrincipal() {
   ...
   * The Kerberos keytab that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final ConsumeKafka_0_10 setSaslKerberosKeytab(final String saslKerberosKeytab) {
   ...
   * The Kerberos keytab that will be used to connect to brokers. If not set, it is expected to set a JAAS configuration file in the JVM properties defined in the bootstrap.conf file. This principal will be set into 'sasl.jaas.config' Kafka's property.
   */
  public final ConsumeKafka_0_10 removeSaslKerberosKeytab() {
   ...
   * Specifies whether the Topic(s) provided are a comma separated list of names or a single regular expression
   */
  public final ConsumeKafka_0_10 setTopicType(final String topicType) {
   ...
   * Specifies whether the Topic(s) provided are a comma separated list of names or a single regular expression
   */
  public final ConsumeKafka_0_10 removeTopicType() {
  ...
  public static final Map<String, String> build(
      final Function<ConsumeKafka_0_10, ConsumeKafka_0_10> configurator) {
    return configurator.apply(new ConsumeKafka_0_10()).build();
  }

  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = ConsumeKafka_0_10.class) final Closure<ConsumeKafka_0_10> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<ConsumeKafka_0_10, ConsumeKafka_0_10> configurator) {
    return configurator.apply(new ConsumeKafka_0_10(properties)).build();
  }
