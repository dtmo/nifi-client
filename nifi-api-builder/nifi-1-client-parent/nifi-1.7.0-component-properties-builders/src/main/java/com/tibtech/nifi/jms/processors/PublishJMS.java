...
public final class PublishJMS {
   ...
   */
  public static final String MESSAGE_BODY_TYPE_PROPERTY = "message-body-type";
   ...
   * The client id to be set on the connection, if set. For durable non shared consumer this is mandatory, for all others it is optional, typically with shared consumers it is undesirable to be set. Please see JMS spec for further details
   */
  public final PublishJMS setConnectionClientId(final String connectionClientId) {
   ...
   * The client id to be set on the connection, if set. For durable non shared consumer this is mandatory, for all others it is optional, typically with shared consumers it is undesirable to be set. Please see JMS spec for further details
   */
  public final PublishJMS removeConnectionClientId() {
   ...
   * The type of JMS message body to construct.
   */
  public final String getMessageBodyType() {
    return properties.get(MESSAGE_BODY_TYPE_PROPERTY);
  }

  /**
   * The type of JMS message body to construct.
   */
  public final PublishJMS setMessageBodyType(final String messageBodyType) {
    properties.put(MESSAGE_BODY_TYPE_PROPERTY, messageBodyType);
    return this;
  }
   ...
   * The type of JMS message body to construct.
   */
  public final PublishJMS removeMessageBodyType() {
    properties.remove(MESSAGE_BODY_TYPE_PROPERTY);
    return this;
  }
   ...
   * The name of the character set to use to construct or interpret TextMessages
   */
  public final PublishJMS setCharacterSet(final String characterSet) {
   ...
   * The name of the character set to use to construct or interpret TextMessages
   */
  public final PublishJMS removeCharacterSet() {
