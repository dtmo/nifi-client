...
public final class GetSQS {
  ...
  public GetSQS(final Map<String, String> properties) {
  ...
  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = GetSQS.class) final Closure<GetSQS> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<GetSQS, GetSQS> configurator) {
    return configurator.apply(new GetSQS(properties)).build();
  }
