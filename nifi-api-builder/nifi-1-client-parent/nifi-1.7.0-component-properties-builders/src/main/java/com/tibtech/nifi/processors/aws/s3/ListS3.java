...
public final class ListS3 {
   ...
   */
  public static final String WRITE_S_3_OBJECT_TAGS_PROPERTY = "write-s3-object-tags";
   ...
   */
  public static final String LIST_TYPE_PROPERTY = "list-type";
   ...
   */
  public static final String MIN_AGE_PROPERTY = "min-age";
   ...
   * If set to 'True', the tags associated with the S3 object will be written as FlowFile attributes
   */
  public final String getWriteS3ObjectTags() {
    return properties.get(WRITE_S_3_OBJECT_TAGS_PROPERTY);
  }

  /**
   * If set to 'True', the tags associated with the S3 object will be written as FlowFile attributes
   */
  public final ListS3 setWriteS3ObjectTags(final String writeS3ObjectTags) {
    properties.put(WRITE_S_3_OBJECT_TAGS_PROPERTY, writeS3ObjectTags);
    return this;
  }
   ...
   * If set to 'True', the tags associated with the S3 object will be written as FlowFile attributes
   */
  public final ListS3 removeWriteS3ObjectTags() {
    properties.remove(WRITE_S_3_OBJECT_TAGS_PROPERTY);
    return this;
  }
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final ListS3 setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final ListS3 removeProxyConfigurationService() {
   ...
   * Proxy username
   */
  public final ListS3 setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final ListS3 removeProxyUserName() {
   ...
   * Proxy password
   */
  public final ListS3 setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final ListS3 removeProxyUserPassword() {
  ...
  public final String getListType() {
    return properties.get(LIST_TYPE_PROPERTY);
  }

  /**
   * Specifies whether to use the original List Objects or the newer List Objects Version 2 endpoint.
   */
  public final ListS3 setListType(final String listType) {
    properties.put(LIST_TYPE_PROPERTY, listType);
    return this;
  }
   ...
   * Specifies whether to use the original List Objects or the newer List Objects Version 2 endpoint.
   */
  public final ListS3 removeListType() {
    properties.remove(LIST_TYPE_PROPERTY);
    return this;
  }
  ...
  public final String getMinAge() {
    return properties.get(MIN_AGE_PROPERTY);
  }

  /**
   * The minimum age that an S3 object must be in order to be considered; any object younger than this amount of time (according to last modification date) will be ignored
   */
  public final ListS3 setMinAge(final String minAge) {
    properties.put(MIN_AGE_PROPERTY, minAge);
    return this;
  }
   ...
   * The minimum age that an S3 object must be in order to be considered; any object younger than this amount of time (according to last modification date) will be ignored
   */
  public final ListS3 removeMinAge() {
    properties.remove(MIN_AGE_PROPERTY);
    return this;
  }
