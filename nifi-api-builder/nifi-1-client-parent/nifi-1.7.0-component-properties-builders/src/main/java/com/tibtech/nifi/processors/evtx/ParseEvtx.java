...
public final class ParseEvtx {
  ...
  public ParseEvtx(final Map<String, String> properties) {
  ...
  public static final Map<String, String> build(
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = ParseEvtx.class) final Closure<ParseEvtx> closure) {
    return build(c -> {
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<ParseEvtx, ParseEvtx> configurator) {
    return configurator.apply(new ParseEvtx(properties)).build();
  }
