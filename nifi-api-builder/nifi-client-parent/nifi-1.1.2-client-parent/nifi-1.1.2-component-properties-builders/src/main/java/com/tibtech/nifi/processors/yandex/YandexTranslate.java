...
public final class YandexTranslate {
  ...
  public static final Map<String, String> build(final Function<YandexTranslate, YandexTranslate> configurator) {
    return configurator.apply(new YandexTranslate()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = YandexTranslate.class) final Closure<YandexTranslate> closure) {
    return build(c -> {
