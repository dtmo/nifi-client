...
public final class PutCouchbaseKey {
   ...
   * A Couchbase Cluster Controller Service which manages connections to a Couchbase cluster.
   */
  public final PutCouchbaseKey setCouchbaseClusterControllerService(final String couchbaseClusterControllerService) {
   ...
   * A Couchbase Cluster Controller Service which manages connections to a Couchbase cluster.
   */
  public final PutCouchbaseKey removeCouchbaseClusterControllerService() {
  ...
  public static final Map<String, String> build(final Function<PutCouchbaseKey, PutCouchbaseKey> configurator) {
