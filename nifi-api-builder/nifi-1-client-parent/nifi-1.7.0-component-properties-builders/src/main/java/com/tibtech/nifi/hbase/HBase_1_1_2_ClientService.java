...
public final class HBase_1_1_2_ClientService {
   ...
   * Comma-separated list of Hadoop Configuration files, such as hbase-site.xml and core-site.xml for kerberos, including full paths to the files.
   */
  public final HBase_1_1_2_ClientService setHadoopConfigurationFiles(
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final HBase_1_1_2_ClientService setKerberosCredentialsService(
   ...
   * Specifies the Kerberos Credentials Controller Service that should be used for authenticating with Kerberos
   */
  public final HBase_1_1_2_ClientService removeKerberosCredentialsService() {
   ...
   * The ZooKeeper ZNode Parent value for HBase (example: /hbase). Required if Hadoop Configuration Files are not provided.
   */
  public final HBase_1_1_2_ClientService setZooKeeperZNodeParent(
      final String zooKeeperZNodeParent) {
   ...
   * The full path to the Phoenix client JAR. Required if Phoenix is installed on top of HBase.
   */
  public final HBase_1_1_2_ClientService setPhoenixClientJarLocation(
      final String phoenixClientJarLocation) {
