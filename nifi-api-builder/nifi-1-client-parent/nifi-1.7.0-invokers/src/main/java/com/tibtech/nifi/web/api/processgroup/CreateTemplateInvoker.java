...
public final class CreateTemplateInvoker extends ComponentEntityInvoker<TemplateEntity> {
  ...
  public CreateTemplateInvoker(final Transport transport, final long version) {
  ...
  /**
   * The create template request. */
  public final CreateTemplateInvoker setCreateTemplateRequestEntity(
  ...
  public final TemplateEntity invoke() throws InvokerException {
    // nifi-api/process-groups/{id}/templates
