...
public final class EvaluateJsonPath {
  ...
  public static final Map<String, String> build(final Function<EvaluateJsonPath, EvaluateJsonPath> configurator) {
    return configurator.apply(new EvaluateJsonPath()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = EvaluateJsonPath.class) final Closure<EvaluateJsonPath> closure) {
    return build(c -> {
