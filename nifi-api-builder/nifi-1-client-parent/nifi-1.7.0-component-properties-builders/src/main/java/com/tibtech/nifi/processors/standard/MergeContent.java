...
public final class MergeContent {
   ...
   */
  public static final String MERGECONTENT_METADATA_STRATEGY_PROPERTY = "mergecontent-metadata-strategy";
  ...
  /**
   * If using the Tar Merge Format, specifies if the Tar entry should store the modified timestamp either by expression (e.g. ${file.lastModifiedTime} or static value, both of which must match the ISO8601 format 'yyyy-MM-dd'T'HH:mm:ssZ'; if using other merge strategy or left blank, this value is ignored
   */
  public static final String TAR_MODIFIED_TIME_PROPERTY = "Tar Modified Time";
   ...
   * For FlowFiles whose input format supports metadata (Avro, e.g.), this property determines which metadata should be added to the bundle. If 'Use First Metadata' is selected, the metadata keys/values from the first FlowFile to be bundled will be used. If 'Keep Only Common Metadata' is selected, only the metadata that exists on all FlowFiles in the bundle, with the same value, will be preserved. If 'Ignore Metadata' is selected, no metadata is transferred to the outgoing bundled FlowFile. If 'Do Not Merge Uncommon Metadata' is selected, any FlowFile whose metadata values do not match those of the first bundled FlowFile will not be merged.
   */
  public final String getMergecontentMetadataStrategy() {
    return properties.get(MERGECONTENT_METADATA_STRATEGY_PROPERTY);
  }

  /**
   * For FlowFiles whose input format supports metadata (Avro, e.g.), this property determines which metadata should be added to the bundle. If 'Use First Metadata' is selected, the metadata keys/values from the first FlowFile to be bundled will be used. If 'Keep Only Common Metadata' is selected, only the metadata that exists on all FlowFiles in the bundle, with the same value, will be preserved. If 'Ignore Metadata' is selected, no metadata is transferred to the outgoing bundled FlowFile. If 'Do Not Merge Uncommon Metadata' is selected, any FlowFile whose metadata values do not match those of the first bundled FlowFile will not be merged.
   */
  public final MergeContent setMergecontentMetadataStrategy(
      final String mergecontentMetadataStrategy) {
    properties.put(MERGECONTENT_METADATA_STRATEGY_PROPERTY, mergecontentMetadataStrategy);
    return this;
  }
   ...
   * For FlowFiles whose input format supports metadata (Avro, e.g.), this property determines which metadata should be added to the bundle. If 'Use First Metadata' is selected, the metadata keys/values from the first FlowFile to be bundled will be used. If 'Keep Only Common Metadata' is selected, only the metadata that exists on all FlowFiles in the bundle, with the same value, will be preserved. If 'Ignore Metadata' is selected, no metadata is transferred to the outgoing bundled FlowFile. If 'Do Not Merge Uncommon Metadata' is selected, any FlowFile whose metadata values do not match those of the first bundled FlowFile will not be merged.
   */
  public final MergeContent removeMergecontentMetadataStrategy() {
    properties.remove(MERGECONTENT_METADATA_STRATEGY_PROPERTY);
    return this;
  }
   ...
   * If using the Tar Merge Format, specifies if the Tar entry should store the modified timestamp either by expression (e.g. ${file.lastModifiedTime} or static value, both of which must match the ISO8601 format 'yyyy-MM-dd'T'HH:mm:ssZ'; if using other merge strategy or left blank, this value is ignored
   */
  public final String getTarModifiedTime() {
    return properties.get(TAR_MODIFIED_TIME_PROPERTY);
  }

  /**
   * If using the Tar Merge Format, specifies if the Tar entry should store the modified timestamp either by expression (e.g. ${file.lastModifiedTime} or static value, both of which must match the ISO8601 format 'yyyy-MM-dd'T'HH:mm:ssZ'; if using other merge strategy or left blank, this value is ignored
   */
  public final MergeContent setTarModifiedTime(final String tarModifiedTime) {
    properties.put(TAR_MODIFIED_TIME_PROPERTY, tarModifiedTime);
    return this;
  }
   ...
   * If using the Tar Merge Format, specifies if the Tar entry should store the modified timestamp either by expression (e.g. ${file.lastModifiedTime} or static value, both of which must match the ISO8601 format 'yyyy-MM-dd'T'HH:mm:ssZ'; if using other merge strategy or left blank, this value is ignored
   */
  public final MergeContent removeTarModifiedTime() {
    properties.remove(TAR_MODIFIED_TIME_PROPERTY);
    return this;
  }
