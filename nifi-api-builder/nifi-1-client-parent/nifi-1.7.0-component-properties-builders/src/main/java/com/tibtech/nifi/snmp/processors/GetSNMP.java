...
public final class GetSNMP {
  ...
  /**
   * The textual OID to request
   */
  public static final String SNMP_TEXTUAL_OID_PROPERTY = "snmp-textual-oid";
   ...
   * The textual OID to request
   */
  public final String getSnmpTextualOid() {
    return properties.get(SNMP_TEXTUAL_OID_PROPERTY);
  }

  /**
   * The textual OID to request
   */
  public final GetSNMP setSnmpTextualOid(final String snmpTextualOid) {
    properties.put(SNMP_TEXTUAL_OID_PROPERTY, snmpTextualOid);
    return this;
  }
   ...
   * The textual OID to request
   */
  public final GetSNMP removeSnmpTextualOid() {
    properties.remove(SNMP_TEXTUAL_OID_PROPERTY);
    return this;
  }
   ...
   * Pass phrase used for SNMP private protocol
   */
  public final GetSNMP setSnmpPrivateProtocolPassphrase(
      final String snmpPrivateProtocolPassphrase) {
