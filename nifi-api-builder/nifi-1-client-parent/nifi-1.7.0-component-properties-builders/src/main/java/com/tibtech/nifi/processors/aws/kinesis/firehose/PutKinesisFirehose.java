...
public final class PutKinesisFirehose {
   ...
   * The name of kinesis firehose delivery stream
   */
  public final PutKinesisFirehose setAmazonKinesisFirehoseDeliveryStreamName(
      final String amazonKinesisFirehoseDeliveryStreamName) {
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final PutKinesisFirehose setAwsCredentialsProviderService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutKinesisFirehose setProxyConfigurationService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PutKinesisFirehose removeProxyConfigurationService() {
   ...
   * Proxy username
   */
  public final PutKinesisFirehose setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final PutKinesisFirehose removeProxyUserName() {
   ...
   * Proxy password
   */
  public final PutKinesisFirehose setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final PutKinesisFirehose removeProxyUserPassword() {
   ...
   * Endpoint URL to use instead of the AWS default including scheme, host, port, and path. The AWS libraries select an endpoint URL based on the AWS region, but this property overrides the selected endpoint URL, allowing use with other S3-compatible endpoints.
   */
  public final PutKinesisFirehose setEndpointOverrideUrl(final String endpointOverrideUrl) {
   ...
   * Endpoint URL to use instead of the AWS default including scheme, host, port, and path. The AWS libraries select an endpoint URL based on the AWS region, but this property overrides the selected endpoint URL, allowing use with other S3-compatible endpoints.
   */
  public final PutKinesisFirehose removeEndpointOverrideUrl() {
