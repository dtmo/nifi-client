...
public final class PutCloudWatchMetric {
  ...
  public final String getMaximum() {
    return properties.get(MAXIMUM_PROPERTY);
  }

  /**
   * The maximum value of the sample set. Must be a double
   */
  public final PutCloudWatchMetric setMaximum(final String maximum) {
    properties.put(MAXIMUM_PROPERTY, maximum);
    return this;
  }
   ...
   * The maximum value of the sample set. Must be a double
   */
  public final PutCloudWatchMetric removeMaximum() {
    properties.remove(MAXIMUM_PROPERTY);
    return this;
  }
  ...
  public final String getMinimum() {
    return properties.get(MINIMUM_PROPERTY);
  }

  /**
   * The minimum value of the sample set. Must be a double
   */
  public final PutCloudWatchMetric setMinimum(final String minimum) {
    properties.put(MINIMUM_PROPERTY, minimum);
    return this;
  }
   ...
   * The minimum value of the sample set. Must be a double
   */
  public final PutCloudWatchMetric removeMinimum() {
    properties.remove(MINIMUM_PROPERTY);
    return this;
  }
   ...
   * The number of samples used for the statistic set. Must be a double
   */
  public final String getSampleCount() {
    return properties.get(SAMPLE_COUNT_PROPERTY);
  }

  /**
   * The number of samples used for the statistic set. Must be a double
   */
  public final PutCloudWatchMetric setSampleCount(final String sampleCount) {
    properties.put(SAMPLE_COUNT_PROPERTY, sampleCount);
    return this;
  }
   ...
   * The number of samples used for the statistic set. Must be a double
   */
  public final PutCloudWatchMetric removeSampleCount() {
    properties.remove(SAMPLE_COUNT_PROPERTY);
    return this;
  }
  ...
  public final String getSum() {
    return properties.get(SUM_PROPERTY);
  }

  /**
   * The sum of values for the sample set. Must be a double
   */
  public final PutCloudWatchMetric setSum(final String sum) {
    properties.put(SUM_PROPERTY, sum);
    return this;
  }
   ...
   * The sum of values for the sample set. Must be a double
   */
  public final PutCloudWatchMetric removeSum() {
    properties.remove(SUM_PROPERTY);
    return this;
  }
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final PutCloudWatchMetric setAwsCredentialsProviderService(
   ...
   * Proxy username
   */
  public final PutCloudWatchMetric setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final PutCloudWatchMetric removeProxyUserName() {
   ...
   * Proxy password
   */
  public final PutCloudWatchMetric setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final PutCloudWatchMetric removeProxyUserPassword() {
