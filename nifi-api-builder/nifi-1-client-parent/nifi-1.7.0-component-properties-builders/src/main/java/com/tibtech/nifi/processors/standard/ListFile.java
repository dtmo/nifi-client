...
public final class ListFile {
   ...
   */
  public static final String INCLUDE_FILE_ATTRIBUTES_PROPERTY = "Include File Attributes";
   ...
   * Whether or not to include information such as the file's Last Modified Time and Owner as FlowFile Attributes. Depending on the File System being used, gathering this information can be expensive and as a result should be disabled. This is especially true of remote file shares.
   */
  public final String getIncludeFileAttributes() {
    return properties.get(INCLUDE_FILE_ATTRIBUTES_PROPERTY);
  }

  /**
   * Whether or not to include information such as the file's Last Modified Time and Owner as FlowFile Attributes. Depending on the File System being used, gathering this information can be expensive and as a result should be disabled. This is especially true of remote file shares.
   */
  public final ListFile setIncludeFileAttributes(final String includeFileAttributes) {
    properties.put(INCLUDE_FILE_ATTRIBUTES_PROPERTY, includeFileAttributes);
    return this;
  }
   ...
   * Whether or not to include information such as the file's Last Modified Time and Owner as FlowFile Attributes. Depending on the File System being used, gathering this information can be expensive and as a result should be disabled. This is especially true of remote file shares.
   */
  public final ListFile removeIncludeFileAttributes() {
    properties.remove(INCLUDE_FILE_ATTRIBUTES_PROPERTY);
    return this;
  }
   ...
   * Specify timestamp precision at the target system. Since this processor uses timestamp of entities to decide which should be listed, it is crucial to use the right timestamp precision.
   */
  public final ListFile setTargetSystemTimestampPrecision(
   ...
   * Specify timestamp precision at the target system. Since this processor uses timestamp of entities to decide which should be listed, it is crucial to use the right timestamp precision.
   */
  public final ListFile removeTargetSystemTimestampPrecision() {
