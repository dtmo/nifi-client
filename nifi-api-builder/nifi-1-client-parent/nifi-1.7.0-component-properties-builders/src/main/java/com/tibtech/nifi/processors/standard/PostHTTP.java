...
public final class PostHTTP {
  ...
  /**
   * The URL to POST to. The URL may be defined using the Attribute Expression Language. A separate connection pool will be created for each unique host:port combination.
   */
   ...
   * Specifies the Regular Expression that determines the names of FlowFile attributes that should be sent as HTTP Headers
   */
  public final PostHTTP setAttributesToSendAsHttpHeadersRegex(
      final String attributesToSendAsHttpHeadersRegex) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PostHTTP setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final PostHTTP removeProxyConfigurationService() {
