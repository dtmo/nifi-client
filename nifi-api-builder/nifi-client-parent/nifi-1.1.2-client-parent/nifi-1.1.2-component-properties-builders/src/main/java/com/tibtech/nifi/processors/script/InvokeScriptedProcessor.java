...
public final class InvokeScriptedProcessor {
  ...
  public InvokeScriptedProcessor() {
    this.properties = new HashMap<>();
  }

  public InvokeScriptedProcessor(final Map<String, String> properties) {
   ...
   * Comma-separated list of paths to files and/or directories which contain modules required by the script.
   */
  public final InvokeScriptedProcessor setModuleDirectory(final String moduleDirectory) {
  ...
  public final InvokeScriptedProcessor setDynamicProperty(final String name, final String value) {
    properties.put(name, value);
    return this;
  }

  public final InvokeScriptedProcessor removeDynamicProperty(final String name) {
  ...
  public static final Map<String, String> build(final Function<InvokeScriptedProcessor, InvokeScriptedProcessor> configurator) {
    return configurator.apply(new InvokeScriptedProcessor()).build();
  }

  public static final Map<String, String> build(@DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = InvokeScriptedProcessor.class) final Closure<InvokeScriptedProcessor> closure) {
    return build(c -> {
      final Closure<com.tibtech.nifi.processors.script.InvokeScriptedProcessor> code = closure.rehydrate(c, com.tibtech.nifi.processors.script.InvokeScriptedProcessor.class, com.tibtech.nifi.processors.script.InvokeScriptedProcessor.class);
  ...
  public static final Map<String, String> update(final Map<String, String> properties,
      final Function<InvokeScriptedProcessor, InvokeScriptedProcessor> configurator) {
    return configurator.apply(new InvokeScriptedProcessor(properties)).build();
  }

  public static final Map<String, String> update(final Map<String, String> properties,
      @DelegatesTo(strategy = Closure.DELEGATE_ONLY, value = InvokeScriptedProcessor.class) final Closure<InvokeScriptedProcessor> closure) {
