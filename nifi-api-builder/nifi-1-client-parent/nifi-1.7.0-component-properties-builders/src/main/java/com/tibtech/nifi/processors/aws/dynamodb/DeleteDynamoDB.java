...
public final class DeleteDynamoDB {
   ...
   * The items to be retrieved in one batch
   */
  public final DeleteDynamoDB setBatchItemsForEachRequestBetween1And50(
   ...
   * The Controller Service that is used to obtain aws credentials provider
   */
  public final DeleteDynamoDB setAwsCredentialsProviderService(
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final DeleteDynamoDB setProxyConfigurationService(final String proxyConfigurationService) {
   ...
   * Specifies the Proxy Configuration Controller Service to proxy network requests. If set, it supersedes proxy settings configured per component. Supported proxies: HTTP + AuthN
   */
  public final DeleteDynamoDB removeProxyConfigurationService() {
   ...
   * Proxy host name or IP
   */
  public final DeleteDynamoDB setProxyHost(final String proxyHost) {
   ...
   * Proxy host name or IP
   */
  public final DeleteDynamoDB removeProxyHost() {
   ...
   * Proxy host port
   */
  public final DeleteDynamoDB setProxyHostPort(final String proxyHostPort) {
   ...
   * Proxy host port
   */
  public final DeleteDynamoDB removeProxyHostPort() {
   ...
   * Proxy username
   */
  public final DeleteDynamoDB setProxyUserName(final String proxyUserName) {
   ...
   * Proxy username
   */
  public final DeleteDynamoDB removeProxyUserName() {
   ...
   * Proxy password
   */
  public final DeleteDynamoDB setProxyUserPassword(final String proxyUserPassword) {
   ...
   * Proxy password
   */
  public final DeleteDynamoDB removeProxyUserPassword() {
